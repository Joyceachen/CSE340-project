...
-- Safe cleanup first (drops if they exist)
...
-- Add foreign key to classification
...
-- -----------------------
-- Table: account (WITH UNIQUE email)
-- -----------------------
...
VALUES ('Sample','User','sample@example.com','P@ssw0rd')
ON CONFLICT (account_email) DO NOTHING;

-- -----------------------
-- Task 1 queries (Instruction 1-6)
-- -----------------------

-- Instruction 1: Insert Tony Stark
INSERT INTO public.account (account_firstname, account_lastname, account_email, account_password)
VALUES ('Tony', 'Stark', 'tony@starkent.com', 'Iam1ronM@n');

-- Instruction 2: Update Tony Stark to Admin
UPDATE public.account
SET account_type = 'Admin'::account_type
WHERE account_email = 'tony@starkent.com';

-- Instruction 3: Delete Tony Stark
DELETE FROM public.account
WHERE account_email = 'tony@starkent.com';

-- Instruction 4: Replace 'small interiors' -> 'a huge interior' for GM Hummer
UPDATE public.inventory
SET inv_description = REPLACE(inv_description, 'small interiors', 'a huge interior')
WHERE inv_make = 'GM' AND inv_model = 'Hummer';

-- Instruction 5: Inner join to show Sport vehicles (should return two rows)
SELECT i.inv_make, i.inv_model, c.classification_name
FROM public.inventory i
JOIN public.classification c ON i.classification_id = c.classification_id
WHERE c.classification_name = 'Sport';

-- Instruction 6: Update image paths to include '/vehicles'
UPDATE public.inventory
SET inv_image = REPLACE(inv_image, '/images/', '/images/vehicles/'),
    inv_thumbnail = REPLACE(inv_thumbnail, '/images/', '/images/vehicles/');

-- -----------------------
-- W06: message table (Final Enhancement)
-- -----------------------
